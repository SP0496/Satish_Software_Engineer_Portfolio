...
import logo from "/assets/satish-logo.svg";
...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col text-3xl gap-y-2 md:text-4xl">
        ...
        >
          <div className="font-light">
            ...
            <a href="mailto:satishanadasu8@gmail.com" className="text-xl tracking-widest lowercase text-pretty hover:text-white">
